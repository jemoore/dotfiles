...
#  https://github.com/vim-scripts/oceandeep.git
#  https://github.com/wavded/vim-stylus.github
...
repos=(
  ...
  https://github.com/gilgigilgil/anderson.vim.git
)

# After install of YouCompleteMe.git, cd ./vim/bundle/YouCompleteMe.git
# and run 'git submodule update --init --recursive' then 
