...
# Usage:
#
#   curl https://github.com/jemoore/dotfiles/raw/master/install.sh | sh
#
# or:
#
#   ~/.dotfiles/install.sh
...
bindir=$HOME/bin
gitbase=git://github.com/jemoore/dotfiles.git
tarball=http://github.com/jemoore/dotfiles/tarball/master
